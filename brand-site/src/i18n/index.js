  ...
  en: {
    ...
    badminton: {
      ...
      group: {
        ...
        inviteExisting: "Add",
        inviteSent: "Invitation sent. The user must accept it.",
        linkInviteSent: "Link request sent. The user must accept it.",
        makeOwner: "Make owner",
        createUnlinked: "Create without Telegram",
        createUnlinkedHint: "No participants yet — create a new one or add by username.",
  ...
  ru: {
    ...
    badminton: {
      ...
      group: {
        ...
        inviteExisting: "Добавить",
        inviteSent: "Приглашение отправлено. Пользователь должен подтвердить.",
        linkInviteSent: "Запрос на связывание отправлен. Пользователь должен подтвердить.",
        makeOwner: "Сделать владельцем",
        createUnlinked: "Создать без Telegram",
        createUnlinkedHint: "Пока нет участников — создайте нового или добавьте по username.",
