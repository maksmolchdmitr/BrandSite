  ...
  en: {
    ...
    badminton: {
      ...
      group: {
        ...
        inviteLink: "Invite link for anyone",
        inviteLinkHint: "Copy or share in Telegram — the person opens the link and signs in via Telegram.",
  ...
  ru: {
    ...
    badminton: {
      ...
      group: {
        ...
        inviteLink: "Ссылка-приглашение для всех",
        inviteLinkHint: "Скопируй или поделись в Telegram — человек откроет ссылку и войдёт через Telegram.",
