<template>
  <div class="page">
    ...
    <div class="content">
      <div class="topRow">
        <h1 class="title">Singles Games</h1>
      </div>
      <div class="ctaRow">
      ...
      <div class="card">
        ...
        <div v-else-if="currentItems.length === 0" class="empty">No singles games yet.</div>
        <div v-else>
  ...
  methods: {
    ...
    async loadFirstPage() {
      ...
      try {
        ...
        this.error = e?.message || "Failed to load singles games";
      } finally {
        this.loading = false;
      }
    },
